...
class Visualize {
 public:
  ...
  Visualize() {
    ...
    // TOPICS TO PUBLISH
      pubNode3D = n.advertise<geometry_msgs::PoseStamped>("/visualizeNodes3DPose", 100);
       pubNode3D_st = n.advertise<geometry_msgs::PoseStamped>("/visualizeNodes3DPose_st", 100);
  ...
  void publishNode3DPose(Node3D& node);
   ...
   void publishNode3DPose_st(Node3D& node);
