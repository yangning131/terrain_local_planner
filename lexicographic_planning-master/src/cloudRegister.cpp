...
public:
    ...
    void run()
    {
        ...
        // transform cloud
        laserCloudIn->header.frame_id = "velodyne";
        ...
        //  for (int i = 0; i < laserCloudInGlobal->size(); ++i)
        // {
        //     PointType p;
        //     p.x = laserCloudInGlobal->points[i].x;
        //     p.y = laserCloudInGlobal->points[i].y;
        //     p.z = laserCloudInGlobal->points[i].z;
        //     p.intensity = laserCloudInGlobal->points[i].intensity;
