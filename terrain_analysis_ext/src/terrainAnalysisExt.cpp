...
int main(int argc, char** argv)
{
  ...
  ros::Subscriber subOdometry = nh.subscribe<nav_msgs::Odometry>("/odometry/filtered", 5, odometryHandler);

  ros::Subscriber subLaserCloud = nh.subscribe<sensor_msgs::PointCloud2>("/planning/registered_cloud", 5, laserCloudHandler);
